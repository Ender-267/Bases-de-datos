...
DROP CLUSTER cltr INCLUDING TABLES;
...
CREATE INDEX idx_cltr ON CLUSTER cltr;

DROP INDEX idx_barcode;

CREATE INDEX idx_barcode ON Posts(barcode);

DROP INDEX idx_product;

CREATE INDEX idx_product ON Posts(product);
